...
class Ui_calcer(object):
    def setupUi(self, calcer):
        ...
        calcer.resize(339, 531)
        self.centralwidget = QWidget(calcer)
        self.centralwidget.setObjectName(u"centralwidget")
        self.gridLayoutWidget = QWidget(self.centralwidget)
        self.gridLayoutWidget.setObjectName(u"gridLayoutWidget")
        self.gridLayoutWidget.setGeometry(QRect(10, 10, 321, 480))
        ...
        self.gridLayout.addWidget(self.pushl, 7, 0, 1, 1)
        ...
        self.textEdit.setMaximumSize(QSize(16777215, 81))
        ...
        self.gridLayout.addWidget(self.pushr, 7, 1, 1, 1)

        self.pushb = QPushButton(self.gridLayoutWidget)
        self.pushb.setObjectName(u"pushb")
        self.pushb.setMinimumSize(QSize(0, 60))
        self.pushb.setFont(font)

        self.gridLayout.addWidget(self.pushb, 7, 2, 1, 1)

        self.pushc = QPushButton(self.gridLayoutWidget)
        self.pushc.setObjectName(u"pushc")
        self.pushc.setMinimumSize(QSize(0, 60))
        self.pushc.setFont(font)

        self.gridLayout.addWidget(self.pushc, 7, 3, 1, 1)

        self.textEdit2 = QTextEdit(self.gridLayoutWidget)
        self.textEdit2.setObjectName(u"textEdit2")
        self.textEdit2.setMinimumSize(QSize(0, 0))
        self.textEdit2.setMaximumSize(QSize(16777215, 61))
        self.textEdit2.setFont(font)

        self.gridLayout.addWidget(self.textEdit2, 1, 0, 1, 4)
...
#endif // QT_CONFIG(shortcut)
        self.pushb.setText(QCoreApplication.translate("calcer", u"BACK", None))
#if QT_CONFIG(shortcut)
        self.pushb.setShortcut(QCoreApplication.translate("calcer", u"Backspace", None))
#endif // QT_CONFIG(shortcut)
        self.pushc.setText(QCoreApplication.translate("calcer", u"C", None))
#if QT_CONFIG(shortcut)
        self.pushc.setShortcut(QCoreApplication.translate("calcer", u"C", None))
#endif // QT_CONFIG(shortcut)
    # retranslateUi
